...
class Developer_1(Employee_1):
    ...
    def __init__(self, first, last, pay, prog_lang):
        ...
        # Employee_1.__init__(first, last, pay)
...
emp_2 = Employee_1('User', 'Check', 70000)
...
# emp_2 = Employee_1('Test', 'User', 65000, 'C++')
...
# print(issubclass(Manager_1, Employee_1))
...
print(emp_1.first)
print(emp_1.email) # email is not getting updated
...
class Developer_2(Employee_2):
    ...
    def __init__(self, first, last, pay, prog_lang):
        ...
        # multiple inhertence
        super().__init__(first, last, pay)
        # Employee_2.__init__(first, last, pay)
        self.prog_lang = prog_lang
...
print(emp_1.first)
# print(emp_1.email) # email is not getting updated
# print(emp_1.email()) # this parathensis need to be added everywhere
#print(emp_1.full_name())
...
emp_2 = Employee_4('User', 'Check', 70000)
...
# Can't pass the programming lang to Employee class,
# it has not attribute
# emp_2 = Employee_4('Test', 'User', 65000, 'C++')
...
emp_2 = Employee_5('User', 'Check', 70000)
# emp_2 = Developer_5('Test', 'User', 65000, 'C++')

# mgr_1 = Manager_5('Björn', 'Besser', 90000, [emp_1])


# Can't pass the programming lang to Employee class,
# it has not attribute
# emp_2 = Employee_5('Test', 'User', 65000, 'C++')

# emp_str_1 = 'Vipul-Sinha-75000'
# emp_3 = Employee_5.from_string(emp_str_1)
# print(emp_3.email)
# print(emp_3.pay)
# my_day = datetime.date(2017, 1, 31)
# print(my_day)
...
# print(isinstance(mgr_1, Manager_4))
# print(isinstance(emp_2, Manager_4))
# print(isinstance(mgr_1, Employee_5))

# print(issubclass(Manager_4, Employee_5))
